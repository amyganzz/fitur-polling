...
use app\models\MahasiswaPilihan;
use app\models\DosenPilihan;
use yii\db\Command;
            ...
            <div class="col-6 text-center justify-content-center">
                <div class="card border border-dark">
                    ...
                    <div class="card-body">
                        ...
                        <a href="index.php?r=dosen%2Fpilih" class="btn btn-primary btn-block">Pilih Dosen</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-6 text-center justify-content-center">
                <div class="card border border-dark">
                    ...
                    <div class="card-body">
                        ...
                        <a href="index.php?r=mahasiswa%2Fpilih" class="btn btn-primary btn-block">Pilih Dosen</a>
                    </div>
                </div>
            </div>
